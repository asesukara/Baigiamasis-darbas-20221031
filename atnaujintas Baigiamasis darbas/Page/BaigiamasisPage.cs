...
namespace ClassLibrary1.Page
{
    ...
    public class BaigiamasisDPage : BaseDriver
    {
        ...
        private IWebElement closeButton => Driver.FindElement(By.CssSelector("#omnisend-form-63285e2b018728915f150e04-close-action"));
        ...
        public void ResultFivePayMethods()
        {
            ...
            //wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.CssSelector("body > div.footer-bottom.mt-4 > div > div > div > div:nth-child(2) > div > img:nth-child(5)")));
        ...
        public void ResultInputFieldText()
        {
            Assert.IsTrue("27".Equals(inputField.Text.Length));
        }
    }
    ...
    public class BaigiamasisDPage3 : BaseDriver
    {
        ...
        private IWebElement closeCookiesButton => Driver.FindElement(By.CssSelector(".cookie-notice__btn.btn.btn-primary"));
        //Thread.Sleep(5000);
        private IWebElement eParduotuveButton => Driver.FindElement(By.CssSelector(".header-categories__link.header-categories__link--category.link-unstyled.d-inline-block.cursor-pointer.noselect"));
        ...
        public void EShoplistResult()
        {
            ...
            wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.CssSelector(".header-categories__link.header-categories__link--category.link-unstyled.d-inline-block.cursor-pointer.noselect")));
